...
if __name__ == '__main__':
    ...
    # BOTH
    train_data_file = 'epdnew_BOTH_{}_gram.npz'.format(str(ngram))
    ...
    # TATA BOX
    train_data_file = 'epdnew_TATA_BOX_{}_gram.npz'.format(str(ngram))
    data_path = './data/' + '{}_gram'.format(ngram)
    ...
    # NO TATA BOX
    train_data_file = 'epdnew_NO_TATA_BOX_{}_gram.npz'.format(str(ngram))
    data_path = './data/' + '{}_gram'.format(ngram)
